...
contract OverAll {
    ...
    function addStudent(
        ...
        Organisation org = helper.getOrganisation(Orgaganisations, _orgAddr);
    ...
    function getAllCertificates(address _orgAddress) public view returns (certificate[] memory) {
        // Organisation org = getOrganisation();
        Organisation org=helper.getOrganisation(Orgaganisations, _orgAddress);
